...
class Game:
    ...
    def minimax(self,game:Game, depth:int, maximizing_player:bool)->int:
        ...
        if maximizing_player:
            ...
            for move in game.move_candidates():
                ...
                eval = self.minimax(game_clone, depth - 1, False)
            ...
            for move in game.move_candidates():
                game_clone = game.clone()
                game_clone.perform_move(move)
                eval = self.minimax(game_clone, depth - 1, True)
    ...
    def minimax_move(self) -> Tuple[int, CoordPair | None]:
        ...
        for move in self.move_candidates():
            ...
            game_clone.perform_move(move)
            score = self.minimax(game_clone, self.options.max_depth, False)
            if score > best_score:
                best_score = score
                best_move = move
