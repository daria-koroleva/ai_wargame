...
class Game:
    ...
    # Rule 2: Check if units are engaged in combat
        for adj_coord in coords.src.iter_adjacent():
            ...
            # Adversarial unit found adjacent to the source unit
                if unit_s.type in [UnitType.AI, UnitType.Firewall, UnitType.Program]:
                    print("Ai, firewall or program cannot move when engaged in war")
                    return False  # These units cannot move if engaged in combat
